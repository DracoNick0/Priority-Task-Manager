...
{
    public class GoldPanningInvariantTests
    {
        [Fact]
        public void CalculateUrgency_WhenWorkloadFitsWindow_ShouldPreserveCoreSchedulingInvariants()
        {
            ...
            var strategy = new GoldPanningStrategy(profile, events, DeterministicTestFixtures.CreateMockTimeService(now));
            ...
            // Invariant 1: no scheduled chunk may overlap another chunk.
            ...
            // Invariant 2: each chunk must fit inside working-day bounds and avoid blocked event windows.
            ...
            // Invariant 3: when capacity is sufficient, each task keeps its full planned duration.
        ...
        private static string RunAndCaptureSignature(
        ...
        private static UserProfile CloneProfile(UserProfile profile)
        {
            return new UserProfile
            {
