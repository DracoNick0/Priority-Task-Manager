...
namespace PriorityTaskManager.API.Schedule
{
	...
	/// <c>403 Forbidden</c>. Runs the stateless computation in <see cref="ScheduleComputation"/>: the caller
	/// posts its current tasks/events/profile and nothing is persisted server-side.
	/// </summary>
