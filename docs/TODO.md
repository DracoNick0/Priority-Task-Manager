...
- Overhaul test coverage according to docs/TESTING_STRATEGY.md:
  ...
  - Expand interactive console seam adoption from HelpHandler to remaining interactive handlers (for example: Edit, List settings flows, Event interactive flows).
