...
- Task/list/event CRUD and LLM-assisted intake remain free and do not require a subscription; free-tier intake is protected by a request/traffic rate limiter rather than a hard paywall.
